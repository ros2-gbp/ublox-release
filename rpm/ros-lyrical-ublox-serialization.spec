...
%global pkg_name ublox_serialization
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-ublox-serialization
Version:        3.0.0
Release:        3%{?dist}
...
%description
ublox_serialization provides header files for serialization of ROS messages to
and from u-blox message format.
...
%changelog
* Wed Apr 29 2026 Veronica Lane <vmlane@alum.mit.edu> - 3.0.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Veronica Lane <vmlane@alum.mit.edu> - 3.0.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Veronica Lane <vmlane@alum.mit.edu> - 3.0.0-1
- Autogenerated by Bloom
